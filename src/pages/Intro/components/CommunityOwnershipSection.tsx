    ...
    return (
        <section className="mb-40 mt-10 flex flex-wrap md:flex-nowrap gap-x-6 gap-y-10 md:mx-2">
            ...
            <article className="mx-auto text-center md:text-left flex flex-col gap-y-6 justify-center">
                ...
                <p className="mx-auto text-card-foreground max-w-[500px] md:max-w-[300px]">SyncSwap is strong community-driven and designed to be owned by the community.</p>

                <Link className={buttonVariants({
                    variant: "outline",
                    className: "mx-auto md:mx-0 max-w-[270px] flex gap-x-3 text-primary bg-transparent text-[16px]",
                    size: "xl"
