...
export default function Home() {
    return (
        <main className="h-screen bg-homePage animate-portfolio-gradient pt-20">

            <section className="flex flex-col flex-wrap content-start gap-x-1 gap-y-1 ml-16 text-center max-h-[80vh] h-[700px] min-h-[200px]">

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdSwapCalls className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Swap</p>
                </Link>


                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdDataUsage className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Portfolio</p>
                </Link>


                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdToll className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Pool</p>
                </Link>

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdStream className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Earnings</p>
                </Link>

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdWaves className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">My Positions</p>
                </Link>

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdScience className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Pool Wizard</p>
                </Link>

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdCardGiftcard className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Loyalty Program</p>
                </Link>


                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <div className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" >
                ...
                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdCurrencyExchange className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">USDC Conversion</p>
                </Link>

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdRocketLaunch className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Launch</p>
                </Link>

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdElectricBolt className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Move</p>
                </Link>

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdLayers className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Bridges</p>
                </Link>


                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdSettings className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
                    <p className="h-[28px] mt-2 font-medium text-[0.825rem] text-white text-shadow">Settings</p>
                </Link>

                <Link to="#" className="flex flex-col justify-center items-center w-24 h-24 hover:bg-white/25 p-1 rounded-lg">
                    <MdImportContacts className="flex justify-center items-center w-10 h-10 bg-navIcon p-2 text-navIcon-foreground rounded-md" />
