  ...
  return (
    <section className="w-[780px] max-w-[98%] min-w-[350px] px-2 mt-4 z-20 animate-fade-in">
      ...
      <div className="w-full flex mt-8">
        <Card className="rounded-3xl bg-card/70 shadow border-0 mt-8 w-full">
          <Tabs defaultValue="active" className="w-full">
            <CardHeader className="flex flex-row justify-between items-center">
              <h3 className="text-lg font-semibold text-primary-foreground">
                Limit orders
              </h3>
              <TabsList className="bg-card/50 rounded-xl p-1 mb-4">
                <TabsTrigger value="active">Active orders</TabsTrigger>
                <TabsTrigger value="history">Order history</TabsTrigger>
              </TabsList>
            </CardHeader>

            <TabsContent className="min-h-[250px]" value="active">
              <div className="text-center py-8">
                <h4 className="text-lg font-semibold text-primary-foreground mb-3">
                  Can't find any active orders
                </h4>
                <p className="text-sm text-muted-foreground mb-6 max-w-md mx-auto">
                  If you are sure you have previously opened limit orders but
                  don't see them you can still cancel them pressing on the
                  button below.
                </p>
                <Button variant="destructive" className="rounded-xl px-6 py-2">
                  Cancel all orders
                </Button>
              </div>
            </TabsContent>
            <TabsContent  className="min-h-[250px]" value="history">
              <div className="text-center py-8">
                <h4 className="text-lg font-semibold text-primary-foreground mb-3">
                  Active orders are not available
                </h4>
                <Button className="bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white border-0 rounded-xl px-8 py-3 font-semibold">
                  Connect wallet
                </Button>
              </div>
            </TabsContent>
