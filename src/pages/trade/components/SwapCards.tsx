...
export default function SwapCards() {
  return (
    <section className="grid gap-y-1 relative px-1">
      ...
      <div className="absolute z-1 inset-y-1/2 inset-x-1/2 left-[46%] grid justify-center items-center shadow-md transition-transform hover:rotate-180 border-4 border-card text-primary bg-accent hover:bg-primary/[.08] rounded-full cursor-pointer w-9 h-9">
        <FaArrowDown size={12} />
      </div>
