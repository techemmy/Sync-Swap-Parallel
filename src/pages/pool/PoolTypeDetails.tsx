...
function NoPoolDetails() {
  return (
    <section className="mt-10 flex gap-y-5 items-center flex-col text-center">
...
export default function PoolTypeDetails({ poolType }: { poolType: string }) {
  ...
  return (
    <section className="w-full transition-all pt-3 px-6 space-y-4 max-w-[520px]">
      ...
      <Card className="flex gap-x-1 text-sm font-medium border-0 shadow rounded-lg bg-card/70 p-2 w-max">
        <article className="flex gap-x-2 items-center">
          <img
            className="border-[50%] w-4 h-4"
          ...
          />
          <p className="text-primary-foreground">1 ETH</p>
        </article>
        ...
        <article className="flex gap-x-2 items-center">
          ...
          />
          <p className="text-primary-foreground">2,347.419 USDC.e</p>
        </article>
      </Card>
    </section>
  );
